...
import com.sunyinuo.userconfig.service.UserHeadFileUploadService;
 ...
 */
@Service
public class UserHeadFileUploadServiceImpl implements UserHeadFileUploadService {

    private final MongoTemplate mongoTemplate;
    public final RestTemplate restTemplate;

    public UserHeadFileUploadServiceImpl(MongoTemplate mongoTemplate, RestTemplate restTemplate) {
